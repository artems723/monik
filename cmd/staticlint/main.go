// # Custom multichecker for static analysis of Go code.
//
// # To run it, first build it:
//
// # 1. Go to the directory with main.go file from staticlint
//
// # 2. Execute go build -o mychecker
//
// # 3. Run ./mychecker <directory with files to check>, for example ./mychecker ./... will check all files from current directory and subdirectories
...
func main() {
	mychecks := []*analysis.Analyzer{
		...
		OsExitAnalyzer,                 // Package analyzer test if os.Exit calls in main function of package main
	}
